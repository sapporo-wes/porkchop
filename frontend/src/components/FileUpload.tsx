      ...
      <div className="bg-gray-50 p-6 rounded-lg">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-2">
            {/* 全カテゴリを選択 */}
            <button
              onClick={selectAllCategoryAllPrompts}
              disabled={promptsLoading || isUploading}
              className="border-gray-300 text-sm text-green-600 hover:text-green-800 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
              全カテゴリを選択
            </button>
            ...
            <button
              ...
              disabled={isUploading || selectionStats.selectedCount === 0}
            ...
            >
              <FiRefreshCw
                className={`w-4 h-4 mr-1 ${promptsLoading ? "animate-spin" : ""}`}
              />
              更新
            </button>
          </div>
                  ...
                  <div className="p-4 bg-white rounded-t-lg">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <button
                          onClick={() =>
                            toggleCategoryExpanded(category.category)
                          }
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="pt-7">
          <button
            ...
            className="flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors whitespace-nowrap"
          >
            {isUploading ? (
              <>
